...
namespace ShareX.HelpersLib
{
    ...
    // Added based on avif.h and compiler errors
    [StructLayout(LayoutKind.Sequential)]
    ...
    // Minimal representation to access the 'image' pointer in avifDecoder
    // WARNING: This assumes the layout based on avif.h v1.2.1.
    // It's fragile and might break with future libavif versions.
    [StructLayout(LayoutKind.Sequential)]
    public struct AvifDecoderPublicMembers
    {
    ...
    // Corrected struct based on provided avif.h v1.2.1
    ...
    public struct avifEncoder // Partial representation for setting options
    {
        ...
        public int maxThreads; // Use Environment.ProcessorCount for fastest performance
        ...
        // Scaling mode
        public NativeAvifScalingMode scalingMode; // Requires NativeAvifScalingMode struct definition
    ...
    // Add necessary supporting structs if avifEncoder uses them
    [StructLayout(LayoutKind.Sequential)]
    public struct NativeAvifFraction
    {
        public int n;
        public int d;
    }
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct NativeAvifScalingMode
    {
        public NativeAvifFraction horizontal;
        public NativeAvifFraction vertical;
    }
}